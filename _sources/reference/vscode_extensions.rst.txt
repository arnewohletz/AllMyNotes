...
* `Makefile Tools`_: Provide makefile support in VS Code: C/C++ IntelliSense, build, debug/run
* `Open in Browser`_: Add an option to open the current file in your default browser
* `Print`_: Print rendered Markdown and colored code
...
* `Sort lines`_: Sort lines of text
...
.. _Makefile Tools: https://marketplace.visualstudio.com/items?itemName=ms-vscode.makefile-tools
.. _Open in Browser: https://marketplace.visualstudio.com/items?itemName=techer.open-in-browser
.. _Print: https://marketplace.visualstudio.com/items?itemName=pdconsec.vscode-print
...
.. _Sort lines: https://marketplace.visualstudio.com/items?itemName=Tyriar.sort-lines
...
-------------------------------------
* `esbonio`_: An extension for editing Sphinx projects (conflicts with `restructuredText`_)
* `Markdown Preview Mermaid Support`_: Adds Mermaid diagram and flowchart support to VS Code's builtin markdown preview
* `Mermaid Markdown Syntax Highlighting`_: Markdown syntax support for the Mermaid charting language
* `Mermaid Preview`_: Enables live editing and visualization of mermaid supported diagrams
* `PlantUML`_: Rich PlantUML support for Visual Studio Code.
...
* `Table Formatter`_: Format table syntax of Markdown, Textile and reStructuredText
...
.. _Markdown Preview Mermaid Support: https://marketplace.visualstudio.com/items?itemName=bierner.markdown-mermaid
.. _Mermaid Markdown Syntax Highlighting: https://marketplace.visualstudio.com/items?itemName=bpruitt-goddard.mermaid-markdown-syntax-highlighting
.. _Mermaid Preview: https://marketplace.visualstudio.com/items?itemName=vstirbu.vscode-mermaid-preview
.. _PlantUML: https://marketplace.visualstudio.com/items?itemName=jebbs.plantuml
...
.. _Table Formatter: https://marketplace.visualstudio.com/items?itemName=shuworks.vscode-table-formatter
...
* `Pylance`_: A performant, feature-rich language server for Python in VS Code (part of `Python`_ extension)
* `Python`_: Python support (linting, highlighting, debugging and more)
* `Python Debugger`_: Python Debugger extension using debugpy (part of `Python`_ extension)
...
.. _Python Debugger: https://marketplace.visualstudio.com/items?itemName=ms-python.debugpy
...
---------------------------------------
* `Live Server`_: Local development server with live reload feature for static & dynamic pages
